...
//  Bankey
//
//  Created by stamoulis nikolaos on 16/11/23.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    private func layout() {
        ...
        NSLayoutConstraint.activate([
            ...
            view.bottomAnchor.constraint(greaterThanOrEqualToSystemSpacingBelow: nextButton.bottomAnchor, multiplier: 4)
        ])
        // Back
        NSLayoutConstraint.activate([
            backButton.leadingAnchor.constraint(equalToSystemSpacingAfter: view.leadingAnchor, multiplier: 2),
            view.bottomAnchor.constraint(lessThanOrEqualToSystemSpacingBelow: backButton.bottomAnchor, multiplier: 4)
        ])
        // Done
        NSLayoutConstraint.activate([
            view.trailingAnchor.constraint(equalToSystemSpacingAfter: doneButton.trailingAnchor, multiplier: 2),
            view.bottomAnchor.constraint(greaterThanOrEqualToSystemSpacingBelow: doneButton.bottomAnchor, multiplier: 4)
        ])
